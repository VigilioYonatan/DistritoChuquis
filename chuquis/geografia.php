...
<section class="container-wallpaper" id="welcome">
    ...
    <video class="container-wallpaper__video" src="./admin/mediaBD/mediaChuquis/geografia/<?php echo $geografiaVideo; ?>" autoplay muted loop></video>
    <div class="wallpaper">
        <picture class="wallpaper-info">
            <img class="wallpaper-info__img" src="./admin/mediaBD/mediaChuquis/geografia/<?php echo $geografiaFoto; ?>" alt="">
...
<div class="paginador-container">
        <ul class="paginador">
        <?php if($pagina != 1): ?>
            <li class='paginador__list'><a href="chuquis.php?action=geografia&pagina=1"><i class="fas fa-fast-backward"></i></a></li>
            <li class='paginador__list'><a href="chuquis.php?action=geografia&pagina=<?php echo $pagina-1; ?>"><i class="fas fa-step-backward"></i></a></li>
        <?php endif; ?>
         <?php 
            for ($i=1; $i <= $totalPaginas ; $i++) { 
                if($i == $pagina){
                    ...
                    echo "<li class='paginador__list' ><a href='chuquis.php?action=geografia&pagina=$i'>$i</a></li>";
                }
            }
        ?>
            
        <?php  if($pagina != $totalPaginas):?>
            <li class='paginador__list'><a href="chuquis.php?action=geografia&pagina=<?php echo $pagina+1; ?>"><i class="fas fa-step-forward"></i></a></li>
            <li class='paginador__list'><a href="chuquis.php?action=geografia&pagina=<?php echo $totalPaginas; ?>"><i class="fas fa-fast-forward"></i></a></li>
        <?php endif; ?>
        </ul>
    </div>
</div>